...
import com.example.oxyarena.client.AmetraGlaiveCooldownHudController;
...
import com.example.oxyarena.client.ProtectiveBubbleRenderer;
...
public class OXYArenaClient {
    public OXYArenaClient(IEventBus modEventBus, ModContainer container) {
        ...
        AmetraGlaiveCooldownHudController.register();
        ...
        ProtectiveBubbleRenderer.register();
        AmetraGlaiveCooldownSyncPayload.setClientReceiver(AmetraGlaiveCooldownHudController::handleSync);
        ...
        ProtectiveBubbleSyncPayload.setClientReceiver(ProtectiveBubbleRenderer::handleSync);
