...
public class CitrineThrowingDagger extends AbstractArrow {
    ...
    public CitrineThrowingDagger(EntityType<? extends CitrineThrowingDagger> entityType, Level level) {
        super(entityType, level);
        this.setBaseDamage(BASE_DAMAGE);
    }

    public CitrineThrowingDagger(Level level, LivingEntity owner, ItemStack pickupItemStack) {
        super(
    ...
    public CitrineThrowingDagger(Level level, double x, double y, double z, ItemStack pickupItemStack) {
        super(
                ModEntityTypes.CITRINE_THROWING_DAGGER.get(),
                x,
                y,
    ...
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItems.CITRINE_THROWING_DAGGER.get());
    }
